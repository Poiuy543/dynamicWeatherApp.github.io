  ...
  return (
    <div className="flex flex-col w-full max-w-full my-2 justify-start items-start">
      ...
      <textarea
        ...
        {...props}
        {...rest}
        className={`placeholder:text-xs md:placeholder:text-sm bg-white text-black text-xs md:text-sm ${classes} border focus:border-secondary focus:outline-none focus:ring-0 ${
